...
5) run output/OSMOutputFileGeneration
optional) you can run map/OSMGenerateKMLMAP and map/OSMGenerateKMLNode to see how the map look like
6) run output/OSMDivideWayToEdge
7) run adjlist/OSMGenerateAdjList

8) run path/OSMRouting for path routing


Clean Data Process:

1) InputFileGeneration
     writeAverageCube
     readAverageCube(i, 0);
     changeInterval();
