...
class ForwardSearching implements Runnable {
	...
	public void run() {
		...
		// record how many nodes transversal
		...
		//System.out.println("forward transveral node count: " + transverNodeCount);
	}
}
...
class ReverseSearching implements Runnable {
	...
	public void run() {
		...
		//OSMOutput.generateTransversalNodeKML(transversalSet, "reverse_transversal");
		//System.out.println("reverse transveral node count: " + transverNodeCount);
	}
}
