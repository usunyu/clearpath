...
/**
 * This class stores the Link information and its getters/ setters
 */
public class LinkInfo {
  public LinkInfo(long index2, int func_class, String start_node,
...
public LinkInfo(long linkId, int func_class, PairInfo[] nodes, int numPairs) {
		super();
		sensors = new ArrayList<Integer>();
		LinkId = linkId;
		this.func_class = func_class;
...
public LinkInfo(long linkId, PairInfo[] nodes) {
		super();
		sensors = new ArrayList<Integer>();
		LinkId = linkId;
		Nodes = nodes;
	}
public LinkInfo(long linkId, int funcClass, String st_name2, String st_node,
		String end_node, PairInfo[] nodes, int count) {
	super();
	sensors = new ArrayList<Integer>();
	LinkId = linkId;
...
public String toString() {
	return "LinkInfo [LinkId=" + LinkId + ", func_class=" + func_class
			...
			+ ", numPairs=" + numPairs + ", sensors=" + sensors + ", Nodes="
