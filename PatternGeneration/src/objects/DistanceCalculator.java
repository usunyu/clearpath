...
public class DistanceCalculator {
	...
	public static void main(String args[]) {
		System.out.println(CalculationByDistance(new PairInfo(34.28215, -118.74368),
				new PairInfo(34.28214, -118.73976)));
	}
	...
	//
	// double latitude1 = startNode.getLati() * Math.PI / 180.;//
	// coordinate1.Latitude.ToRadian();
	// double latitude2 = endNode.getLati() * Math.PI / 180.;//
