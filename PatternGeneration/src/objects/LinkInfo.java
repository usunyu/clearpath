...
public class LinkInfo {
	...
	// public LinkInfo(String linkIndexId, String link_id, int func_class,
	// String st_name, String start_node,
	// String end_node, PairInfo[] nodes, int numPairs) {
	// super();
	// sensors = new ArrayList<Integer>();
	// LinkId = linkIndexId;
	...
	// public LinkInfo(String id, int linkId, int func_class, String st_name,
	// int startNode,
	// int endNode, ArrayList<PairInfo> nodeList, String dirTravel, int
	// speedCat, int direction) {
	// super();
	// this.id = id;
	// this.linkId = linkId;
	// this.func_class = func_class;
	...
	public LinkInfo(int linkId, int funcClass, String streetName, int startNode,
			int endNode, ArrayList<PairInfo> nodeList, String dirTravel,
			int speedCat, String allDir) {
		super();
		this.linkId = linkId;
